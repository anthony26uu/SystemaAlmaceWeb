...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="text-center">
        ...
        <span>ID / NOMBRE</span>
        <asp:TextBox ID="buscaText" runat="server" class="input-lg" placeholder="ID a buscar" Height="45px" Width="189px"></asp:TextBox>
        &nbsp;
        <asp:Button ID="Button1" runat="server" CssClass="btn-warning" Text="Buscar" Height="45px" Width="96px" OnClick="Button1_Click1" />
        ...
        <asp:DropDownList ID="DropTipo" runat="server" Height="42px" Width="199px">
    ...
    <div class="center-block" style="overflow: auto; width: 1434px; height: 315px;">
        <asp:GridView ID="UsuarioGrid" runat="server" CssClass=" table table-striped table-hover table-bordered" HorizontalAlign="Center" Height="16px" Width="742px">
